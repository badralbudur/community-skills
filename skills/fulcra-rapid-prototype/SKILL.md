...
To ensure reliable agentic execution and prevent skipped steps, you MUST follow the 7-step pipeline below. **Do not skip ahead.** You use `git` locally to track state and artifacts.
